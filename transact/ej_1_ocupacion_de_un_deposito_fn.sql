...
“DEPOSITO COMPLETO”.
*/
CREATE FUNCTION stock_de_un_articulo_en_determinado_deposito(@articulo char(8), @deposito char(2))
...
DECLARE @stock_maximo DECIMAL(12,2)
    ...
    BEGIN
    set @respuesta = CONCAT('OCUPACION DEL DEPOSITO ', @stock_actual/@stock_maximo,'%')
    END
    ELSE
    BEGIN
